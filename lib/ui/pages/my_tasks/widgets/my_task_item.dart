...
class MyTaskItem extends StatefulWidget {
  const MyTaskItem({Key key, @required this.task, @required this.index}) : super(key: key);

  final UserTask task;
  final int index;

  @override
  _MyTasksItemState createState() => _MyTasksItemState();
}

class _MyTasksItemState extends State<MyTaskItem> with AutomaticKeepAliveClientMixin {
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => TaskDetailsPage(title: widget.task.productName, taskId: widget.task.itemId)),
                  );
                },
