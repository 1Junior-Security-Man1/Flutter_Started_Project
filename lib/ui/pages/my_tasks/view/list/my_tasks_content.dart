...
import 'package:bounty_hub_client/ui/pages/my_tasks/my_tasks_state.dart';
import 'package:bounty_hub_client/ui/pages/my_tasks/view/list/my_task_item.dart';
...
class MyTasksContent extends StatefulWidget {
  @override
  _MyTasksContentState createState() => _MyTasksContentState();
}

class _MyTasksContentState extends State<MyTasksContent> {
